def Read_Patients_DataBase() :
	...
	for i in text :
		if flag == 0 :
						...
						if i != ";" :
							Patient_Disease = Patient_Disease + i
						elif i == ";" :
							flag = 7
						...
						if i != "\n" :
							...
							Patients_Dict[int(Patient_ID)]=[Department,Doctor_Name,Patient_Name,Patient_Age,Patient_Gender,Patient_Disease,Patient_Address,RoomNumber]
							Patient_ID = ""
							Department = ""
							Doctor_Name = ""
							Patient_Name = ""
