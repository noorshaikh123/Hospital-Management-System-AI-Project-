						...
						if AdminOptions == "1" :															#Admin mode --> Pateints Management
								...
								if Admin_choice == "1" : 										#Admin mode --> Pateints Management --> Enter new patient data
											try :		#To avoid non integer input
												...
												Patients_DataBase[patient_ID]=[Department,DoctorName,Name,Age,Gender,Disease,Address,RoomNumber]
											...
											try :		#To avoid non integer input
												...
												print("patient disease     : ",Patients_DataBase[patient_ID][5])
												print("patient address     : ",Patients_DataBase[patient_ID][6])
												print("patient room number : ",Patients_DataBase[patient_ID][7])
											...
											try :		#To avoid non integer input
												...
												while True :
													...
													print("|To edit patient Disease Enter 6 :       |")
													print("|To Edit patient Address Enter 7 :       |")
													print("|To Edit patient RoomNumber Enter 8 :    |")
													...
													if Admin_choice == "1" :
														...
														print("----------------------Patient disease edited successfully----------------------")
														
													elif Admin_choice == "7" :
														Patients_DataBase[patient_ID][56]=input("\nEnter patient address : ")
														print("----------------------Patient address edited successfully----------------------")
														
													elif Admin_choice == "8" :
														Patients_DataBase[patient_ID][71]=input("\nEnter patient RoomNumber : ")
