def Write_Patients_DataBase (Pateints_DataBase) :
	...
	for i in Pateints_DataBase :
		myfile.write(str(i)+";"+Pateints_DataBase[i][0]+";"+Pateints_DataBase[i][1]+";"+Pateints_DataBase[i][2]+";"+Pateints_DataBase[i][3]+";"+Pateints_DataBase[i][4]+";"+Pateints_DataBase[i][5]+";"+Pateints_DataBase[i][6]+";"+Pateints_DataBase[i][7]+"\n")
	myfile.close()
